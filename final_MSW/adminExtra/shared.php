...
//Course identifier
$course = "<div class='course'>Admin</div>";

// Page title
$SubTitle_Admin = "<h1>Admin</h1>";
...
/*========================================*/
    function getTags($IID) {
        ...
        if ($stmt->prepare($sql)){
            ...
            $stmt->bind_param("i", $IID);  // note $IID here comes from the function parameter
            ...
            print "<p>Query to retrieve tags failed.<br>\$IID: $IID</p>";
...
/*========================================*/
    function getComments($IID) {
        ...
        if ($stmt->prepare($sql)){
            ...
            $stmt->bind_param("i", $IID);  // note $IID here is the function parameter
